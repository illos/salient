...
| 2026-09-20 | V88 | Potency outcome lines show public inequalities and authorized target scores; hero/foe condition-source labels remain readable; applied/resisted conditions have no manual disposition control through correction and rewind | new | spot | V88 headless runner and persisted condition/presentation tests (execution pending) | |
