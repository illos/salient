...
| V72 | [Live compiled ability effects](V72-live-compiled-effects.md) | V26, V63, V67 | Headless acceptance and independent implementation/rules reviews PASS — full check, 46-record public CLI proof, eight-case occurrence suite; branch handoff pending, Fable owns integration |
