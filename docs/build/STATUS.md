...
| A03 | [Table shell and FreePlay basics](A03-table-shell-freeplay.md) | A | A01, S01 | required | Committed (review deferred to user audit thread; browser test not run; heroes pane provisional pending A02, see Q-A-200) | app/A03-impl | 2026-09-14 | ae9d45a, dc9fbc8, 1dce91b |
