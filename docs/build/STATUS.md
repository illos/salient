...
| V88 | [Compiled potency conditions with automatic save ends](V88-compiled-potency-conditions.md) | V26, V64, V67, V72, R05, V02, V87 (reachability) | Original owner handoff `eefc7cc` passed full, real headless, V72 and both reviews. Seeded inventory addendum in progress on `slice/V88-seeded-inventory`, based on DEPLOY integration `c721d0b`: Bola Knock, Eye Flash, Power Chord and Ghoul Razor Claws need new persisted/live proof before release; 13 reachable / 1222 compatibility / 2 unavailable. Gates through TESTER; owner returns reviewed branch to DEPLOY; browser deferred. | Engine and parser thread (Fable ENGINE2 lead, Astra ENGINE implementer) |
