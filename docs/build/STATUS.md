...
| V71 | [Orc level one](V71-orc-level-one.md) | V45, V65 | In progress — candidate implemented; remote headless verification and reviews pending | Character Astra Orc implementer; `slice/V71` |
