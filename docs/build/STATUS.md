...
| V72 | [Live compiled ability effects](V72-live-compiled-effects.md) | V26, V63, V67 | Integration verification — rebased onto `42211f5` as `67027b0`/`a68a047`; integrated local full check PASS (843 tests/build); repeated isolated CLI proofs PASS (46 + 14 records); renewed independent integration review PASS; branch handoff ready; Fable owns main integration |
