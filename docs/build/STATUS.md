...
| V02 | [Minion squads and captains](V02-minions-and-captains.md) | A09 | In review — built on `slice/V02` (`.worktrees/minions`), 2026-09-20; full local checks and the 9-step authenticated headless proof pass; independent implementation and rules reviews pending; not merged |
