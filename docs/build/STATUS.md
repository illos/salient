...
| V72 | [Live compiled ability effects](V72-live-compiled-effects.md) | V26, V63, V67 | Committed on branch — `ed564b3`; full check, 46-record public CLI proof, eight-case occurrence suite and independent implementation/rules reviews PASS; Fable owns integration |
