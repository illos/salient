...
Updated 2026-09-20 16:00 UTC: V88 real-headless passed on an isolated local target; its mandatory V72 CT114 regressions are next.
...
| `test-V88-1af9c75-8-v72-regressions` / 916 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | frozen `1af9c7509400d493d690851e4d3e5b0f6ecad30a`; retained `engine-live` exact detached snapshot; V72 main runner then adapted runner with dice helper | **In progress**: CT114 capacity healthy; named `engine-live` stopped before setup; serial deploy/seed/runs/cleanup | artifacts: `/srv/presidium/projects/salient/test-artifacts/V88-1af9c75-v72-20260920T160100Z` |
