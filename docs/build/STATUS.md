...
| V112 | [Live sign-in latency investigation](V112-signin-latency.md) | API and live Firefox investigation recorded; 1.84–2.35s browser sign-in; user's 20s session gap remains unresolved |
