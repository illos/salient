...
| V68 | [Campaign home redesign](V68-campaign-home.md) | V21, V29, V31, V43, A09 | Committed — branch handoff on `slice/V68` (`code/.worktrees/campaign-home`), not merged; independent review pass 2026-09-20 ([record](reviews/V68-implementation-review.md)); isolated CT114 env `campaign-home`: full `pnpm check` exit 0 (284 engine, 425 app/scripts tests, build) and 8/8 headless proof; main integration and shared-main runtime update await the user's merge request | Campaign home UI thread (Fable) |
