...
Updated 2026-09-20 15:42 UTC: repaired V88 `a07dd27` passed and its result wake was accepted;
its two runtime jobs are held before setup pending a reviewed replacement candidate. The shared-main
V87/V02 live job is running on the verified `4d6d299` CT114 deployment. The rebased V87 pre-merge integration check passed and its result wake
...
| --- | --- | --- | --- | --- |
| `test-V88-a07dd27-4-v72-regressions` / 894 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | frozen `a07dd279cb5dc98f92d231d4c9fae52812a7a7f7`; named `engine-live` V72 main and adapted runners with dice helper | **Held before setup** by ENGINE message 896 pending reviewed replacement source | no execution or environment change |
| `test-V88-a07dd27-3-headless` / 890 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | frozen `a07dd279cb5dc98f92d231d4c9fae52812a7a7f7`; isolated real BetterAuth/API V88 runner with exact app source/URL guard, committed content seed and retained disposable data | **Held before setup** by ENGINE message 896 pending reviewed replacement source | no execution or environment change |
| `test-V87-main-4d6d299-live-1` / 887 | FOES2 `f8589dc3-76c4-4527-8d87-b4c9d13fd9d8` | deployed main `4d6d299`; shared CT114 V02 9-scenario runner plus bounded authenticated content/foe readback against reseeded 1151-entry app | **Running**: shared CT114 main target, Compose `salient-dev-b90776c53141`; no deploy/upload/build | artifacts: `/srv/presidium/projects/salient/test-artifacts/V87-main-4d6d299-20260920T154031Z` |
