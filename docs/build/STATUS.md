...
Updated 2026-09-20 14:55 UTC: V75 is queued next after V87 stopped at its first focused gate because
a new test derives an invalid command ID from a slash-containing content ID. No V87 backend started.
V85/V86 remains blocked after its hosted runner exhausted the shared budget before its four cases.
