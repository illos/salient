...
| V68 | [Campaign home redesign](V68-campaign-home.md) | V21, V29, V31, V43, A09 | In review — candidate `136f7e2` on `slice/V68` (`code/.worktrees/campaign-home`), evidence `04fb7e7`; isolated CT114 env `campaign-home`: full `pnpm check` exit 0 (284 engine, 423 app/scripts tests, build) and 8/8 headless proof steps pass; independent review running; not merged, shared main untouched | Campaign home UI thread (Fable) |
