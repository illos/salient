...
Updated 2026-09-20 16:43 UTC: repaired V88 seeded-inventory candidate `21ec7ca` passed local gates; dependent real-headless is active on an exclusive local anonymous target.
...
| --- | --- | --- | --- | --- |
| `test-V88-21ec7ca-13-seeded-headless` / 972 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | dependent on job 12 pass; frozen `21ec7cadcdc4a7abe04d5116cdad4d3bcd6f8b3c`; guarded seeded helper plus real public V88 runner against exact 1151-row corpus | **In progress**: exclusive local anonymous target selected; setup/helper/runner/cleanup serialized; no main/cloud/browser | artifacts: `/srv/presidium/projects/salient/test-artifacts/V88-21ec7ca-seeded-headless-20260920T164300Z` |
