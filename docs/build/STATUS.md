...
| V144 | [Null discipline generation and the observed Malice trigger](V144-null-discipline-generation.md) | In testing (resource train 4); independent review PASS, QC1 static PASS |
| V147 | [Conduit piety generation: prayer and domain triggers](V147-conduit-piety-generation.md) | In testing (resource train 4); independent review PASS, QC1 static PASS |
| V149 | [Troubadour drama generation](V149-troubadour-drama-generation.md) | In testing (resource train 4); independent review PASS, QC1 static PASS |
| V148 | [Elementalist essence generation with Persistent Magic](V148-elementalist-essence-generation.md) | In testing (resource train 4); independent review PASS, QC1 static PASS |
