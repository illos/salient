...
Updated 2026-09-20 15:57 UTC: V88 real-headless is active on an isolated local target; its mandatory V72 CT114 regressions are queued next.
...
| --- | --- | --- | --- | --- |
| `test-V88-1af9c75-7-headless` / 915 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | frozen `1af9c7509400d493d690851e4d3e5b0f6ecad30a`, `.worktrees/engine-potency`; isolated real BetterAuth/API V88 runner with exact app source/URL guard and committed 595-entry seed | **In progress**: isolated local anonymous Convex target selected after capacity check; setup/deploy/seed/headless and cleanup serialized | artifacts: `/srv/presidium/projects/salient/test-artifacts/V88-1af9c75-headless-20260920T155700Z` |
| `test-V88-1af9c75-8-v72-regressions` / 916 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | frozen `1af9c7509400d493d690851e4d3e5b0f6ecad30a`; retained `engine-live` exact detached snapshot; V72 main runner then adapted runner with dice helper | **Queued** behind job 7; named CT114 `engine-live`; serial setup/runs, preserve data, stop job services | unique V88 artifacts pending |
