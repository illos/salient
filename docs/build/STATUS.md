...
Updated 2026-09-20 16:32 UTC: V88 seeded-inventory candidate `498778e` is running focused and full local gates; no runtime target is active.
...
| --- | --- | --- | --- | --- |
| `test-V88-498778e-11-seeded-headless` / 965 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | dependent on job 10 pass; same frozen `498778eb3ae788b3badc28b90bd6f8f4eb07827a`; guarded seeded helper plus real public V88 runner against exact 1151-row corpus | **Queued** behind job 10; isolated anonymous local or named `engine-potency-seeded`; no main/cloud/browser | unique V88 attempt artifacts pending |
| `test-V88-498778e-10-seeded-gates` / 963 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | frozen `498778eb3ae788b3badc28b90bd6f8f4eb07827a`, `.worktrees/engine-potency-seeded`, exact integration base `c721d0b`; focused potency/report files then `CI=true pnpm check` | **In progress**: local pure gates, one worker/serial; no stack, deployment, data mutation or browser | artifacts: `/srv/presidium/projects/salient/test-artifacts/V88-498778e-seeded-20260920T163200Z` |
