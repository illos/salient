...
| V212 | [Foe source accounting and action discovery](V212-foe-source-and-actions.md) | Merged (`33f53337`); cloud dev backend/frontend published; Test and QC PASS |
...
| V227 | [Thorn Dragon linked effects; Domain deferred](V227-thorn-dragon-effects.md) | Registered |
