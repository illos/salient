...
| V26 | [Compiled ability effects: damage and push instructions](V26-compiled-ability-effects.md) | S01, S02, A01, A02, A04, A05, A06, A09 | Outline — specification reviewed and committed on `slice/V26`, 2026-09-16; user checkpoint: paused during Brutal Slam design; ability scope accepted; per-ability source design and live screenshot evidence required; implementation not started; lead integration pending |
