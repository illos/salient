...
Updated 2026-09-20 15:48 UTC: V88 fixture repair `1af9c75` is running its focused test and full
local gate. The superseded `c220cbc` focused failure remains preserved below.
...
| --- | --- | --- | --- | --- |
| `test-V88-1af9c75-6-alias-fixture` / 908 | ENGINE `2b1ba081-4040-4665-9ea2-22364db707f4`; copy ENGINE2 `3498baf0-e8d9-442b-a704-f24f7e595b30` | frozen `1af9c7509400d493d690851e4d3e5b0f6ecad30a`; fixture-only alias-aware Wode redo repair, focused file then `CI=true pnpm check` covering retained `c220cbc` production logging change | **Running**: local pure/`convex-test`; no stack, deployment, upload or browser | artifacts: `/srv/presidium/projects/salient/test-artifacts/V88-1af9c75-20260920T154801Z` |
