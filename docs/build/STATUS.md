...
| V85 | [Complication grants and dependencies](V85-complications.md) | V37, V83 | Built on branch — 864 local tests pass; live API blocked by deployment; unmerged | Astra character lead |
| V86 | [Starting reward fulfillment](V86-starting-rewards.md) | V37, V85 | Built on branch — one-time rewards and item actions; same deployment blocker; unmerged | Astra character lead |
