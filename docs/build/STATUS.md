...
| V64 | [Ability grammar coverage audit](V64-ability-coverage-audit.md) | V26 specification, S01, V35 | In review — read-only audit script, report and tests committed on `slice/V64-ability-coverage-audit` (worktree `.worktrees/engine-audit`), not merged; no runtime impact; independent review pass (2026-09-20) | Engine and parser thread |
