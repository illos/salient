...
Updated 2026-09-20 14:57 UTC: V75 is queued first, followed by corrected V87 and five bounded
...
| --- | --- | --- | --- | --- |
| `test-V75-2c7cfe2-1` / 816 | UI `b2d5e5ec-76c4-4527-8d87-b4c9d13fd9d8` | `2c7cfe29b457c7049d78461cc6f5063a20e4329c`, `.worktrees/quiet-theme`; `CI=true pnpm check`, then optional user-requested pop-up capture | **Queued**: local pure gate first; candidate has only its declared untracked `node_modules` symlink input | Pending |
