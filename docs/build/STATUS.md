...
| V83 | [Core perk and ordinary kit action coverage](V83-supporting-actions.md) | V37, V74, V82 | Reviewed and API verified — main/shared-app delivery pending | Astra character lead |
| V84 | [Culture presets](V84-culture-presets.md) | V37, V83 | Reviewed and API verified — 27 presets plus Bespoke; main delivery pending | Astra character lead |
