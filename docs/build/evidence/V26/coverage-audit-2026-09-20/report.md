...
Content hash: `sha256:64a08e925f76657409df983b706d2599edcb499457e9b21325d65ee7268c10d8`. Foe catalog edition: `bf262edf546e91e1540cc17489915f18c4873ddd8bd8e225b20f3441e3f74f30`. Source revision: `fb83a789da8f0327a389c277a0c790b1648d5810`.

## Totals per corpus

| Corpus | Total | COMPILES | COMPILES_WITH_REMAINDER | of which within V26 bounded remainder | NO_MATCH |
| --- | ---: | ---: | ---: | ---: | ---: |
| Hero standalone (`ability.json`) | 52 | 8 | 22 | 1 | 22 |
| Kit signature (`kit.json`) | 25 | 2 | 19 | 1 | 4 |
| Class/other grants with their own text | 15 | 1 | 2 | 0 | 12 |
| Foe abilities (`foes/catalog.json`) | 1158 | 20 | 566 | 14 | 572 |
| Malice features with a power roll | 14 | 0 | 13 | 0 | 1 |

Wizard ability grants inspected: 132 (54 resolve to a standalone entry, 42 to a kit signature, 36 classified from their own embedded text, 0 unresolved).

## What the bounded V26 grammar buys

- Foe abilities: 586 of 1158 (50.60%) have tiers the grammar compiles: 20 fully (1.73%), 566 with a typed remainder (48.88%), of which 14 (1.21%) are within V26's bounded potency remainder. 572 (49.40%) do not match.
- Hero abilities (standalone + kit signatures + own-text grants): 54 of 92 (58.70%) compile: 11 fully (11.96%), 43 with a typed remainder (46.74%), of which 2 (2.17%) are within the bounded potency remainder. 38 (41.30%) do not match.
...
| Hero standalone (`ability.json`) | COMPILES_WITH_REMAINDER | 13 | 0 | 7 | 1 | 1 |
...
| hero-standalone | Draconian Pride | COMPILES | — | area | not-granted | — | — |
| hero-standalone | Dragon Breath | COMPILES_WITH_REMAINDER | — | area | not-granted | — | effect-paragraph:effect |
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | effect-paragraph | effect-paragraph:effect | 1016 | 1003 | `complication:Corrupted Mentor/corrupt-spirit`, `complication:Dragon Dreams/dragon-breath`, `complication:Grounded/motivate-earth` |
| 2 | no-power-roll | no-power-roll | 518 | 518 | `complication:Corrupted Mentor/corrupt-spirit`, `complication:Grounded/motivate-earth`, `complication:Lost Your Head/share-head` |
...
| 5 | slide | slide N | 74 | 29 | `mcdm.heroes.v1/feature.ability.fury.level-1/out-of-the-way`, `mcdm.heroes.v1/kit/pugilist/let-s-dance`, `mcdm.heroes.v1/kit/stick-and-robe/where-i-want-you` |
...
| --- | ---: | ---: |
| effect-paragraph | 1063 | 6 |
| potency-condition | 926 | 176 |
| no-power-roll | 518 | 1 |
| tier-damage | 206 | 75 |
| trigger | 179 | 1 |
| malice-spend | 151 | 2 |
...
| extra-table | 55 | 2 |
| shift | 40 | 24 |
| roll-expression | 28 | 5 |
| push-with-extra | 26 | 11 |
| resource-spend | 8 | 4 |
| extra-damage | 3 | 1 |
| second-roll | 1 | 1 |
...
| granted | no-power-roll | 8 |
| granted | roll-expression-outside-grammar | 3 |
| granted | tier1-damage-outside-grammar | 1 |
| hero-standalone | no-power-roll | 15 |
| hero-standalone | roll-expression-outside-grammar | 1 |
