...
Content hash: `sha256:9bcde574efb5facb4741f329a92879f31d5e49feedd0f31baa61e507522f3ec2`. Foe catalog edition: `bf262edf546e91e1540cc17489915f18c4873ddd8bd8e225b20f3441e3f74f30`. Source revision: `fb83a789da8f0327a389c277a0c790b1648d5810`.

## Totals per corpus

| Corpus | Total | COMPILES | COMPILES_WITH_REMAINDER | of which within V88 bounded remainder | NO_MATCH |
| --- | ---: | ---: | ---: | ---: | ---: |
| Hero standalone (`ability.json`) | 256 | 10 | 112 | 10 | 134 |
...
Wizard ability grants inspected: 1215 (792 resolve to a standalone entry, 75 to a kit signature, 348 classified from their own embedded text, 0 unresolved).
...
- Hero abilities (standalone + kit signatures + own-text grants): 146 of 353 (41.36%) compile: 13 fully (3.68%), 133 with a typed remainder (37.68%), of which 11 (3.12%) are within the bounded potency remainder. 207 (58.64%) do not match.
...
| Hero standalone (`ability.json`) | COMPILES_WITH_REMAINDER | 89 | 2 | 18 | 2 | 1 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| hero-standalone | Bodyswap | COMPILES_WITH_REMAINDER | — | single | selectable | class.beastheart.signature-ability@1:selectable, class.beastheart.signature-ability@2:selectable, class.beastheart.signature-ability@3:selectable | effect-paragraph:effect |
| hero-standalone | Bring the Thunder | COMPILES_WITH_REMAINDER | — | area | selectable | class.beastheart.ability-3@1:selectable, class.beastheart.ability-3@2:selectable, class.beastheart.ability-3@3:selectable | resource-spend:spend N ferocity; potency:P < SYM taunted (save ends); potency:P < SYM frightened (save ends) |
| hero-standalone | Come On! | COMPILES_WITH_REMAINDER | — | single | selectable | class.beastheart.signature-ability@1:selectable, class.beastheart.signature-ability@2:selectable, class.beastheart.signature-ability@3:selectable | effect-paragraph:effect |
| hero-standalone | Covering Fire | COMPILES_WITH_REMAINDER | — | single | selectable | class.beastheart.signature-ability@1:selectable, class.beastheart.signature-ability@2:selectable, class.beastheart.signature-ability@3:selectable | effect-paragraph:effect |
| hero-standalone | Feral Strike | COMPILES_WITH_REMAINDER | — | area | selectable | class.beastheart.features@1:selectable, class.beastheart.features@2:selectable, class.beastheart.features@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:effect |
| hero-standalone | Herd the Sheep | COMPILES_WITH_REMAINDER | — | single | selectable | class.beastheart.ability-3@1:selectable, class.beastheart.ability-3@2:selectable, class.beastheart.ability-3@3:selectable | effect-paragraph:effect; potency:I < SYM weakened (save ends); slide N |
| hero-standalone | Hungry Like the Wolf | COMPILES_WITH_REMAINDER | — | single | selectable | class.beastheart.ability-3@1:selectable, class.beastheart.ability-3@2:selectable, class.beastheart.ability-3@3:selectable | your companion can spend a recovery; you and your companion can each spend a recovery; potency:A < SYM bleeding (eot); you and your companion can each spend a recovery and shift up to N squares |
| hero-standalone | I Feed On Your Pain! | COMPILES_WITH_REMAINDER | — | single | selectable | class.beastheart.ability-5@1:selectable, class.beastheart.ability-5@2:selectable, class.beastheart.ability-5@3:selectable | effect-paragraph:effect; potency:M < SYM bleeding (save ends) |
| hero-standalone | Pushover | COMPILES_WITH_REMAINDER | — | single | selectable | class.beastheart.ability-3@1:selectable, class.beastheart.ability-3@2:selectable, class.beastheart.ability-3@3:selectable | effect-paragraph:effect |
| hero-standalone | Rain of Fire | COMPILES_WITH_REMAINDER | — | area | selectable | class.beastheart.ability-5@1:selectable, class.beastheart.ability-5@2:selectable, class.beastheart.ability-5@3:selectable | effect-paragraph:effect |
| hero-standalone | You Let Me Get Too Close | COMPILES_WITH_REMAINDER | — | single | selectable | class.beastheart.ability-5@1:selectable, class.beastheart.ability-5@2:selectable, class.beastheart.ability-5@3:selectable | effect-paragraph:effect; potency:M < SYM grabbed |
...
| hero-standalone | Essence Transfer | COMPILES_WITH_REMAINDER | — | single | selectable | class.summoner.ability-5@1:selectable, class.summoner.ability-5@2:selectable, class.summoner.ability-5@3:selectable | effect-paragraph:effect; N charges (see below); N charges |
| hero-standalone | Summoner's Sword | COMPILES_WITH_REMAINDER | — | single | selectable | class.summoner.ability-5@1:selectable, class.summoner.ability-5@2:selectable, class.summoner.ability-5@3:selectable | effect-paragraph:effect |
...
| hero-standalone | Awe | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.ability-3@1:selectable, class.talent.ability-3@2:selectable, class.talent.ability-3@3:selectable | effect-paragraph:effect; potency:I < SYM frightened (save ends) |
| hero-standalone | Choke | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.ability-3@1:selectable, class.talent.ability-3@2:selectable, class.talent.ability-3@3:selectable | effect-paragraph:effect; potency:M < SYM slowed (save ends); potency:M < SYM restrained (save ends) |
| hero-standalone | Entropic Bolt | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.signature-abilities@1:selectable, class.talent.signature-abilities@2:selectable, class.talent.signature-abilities@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:effect; effect-paragraph:strained; potency:P < SYM slowed (save ends) |
| hero-standalone | Hoarfrost | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.signature-abilities@1:selectable, class.talent.signature-abilities@2:selectable, class.talent.signature-abilities@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:strained; potency:M < SYM slowed (eot) |
| hero-standalone | Incinerate | COMPILES_WITH_REMAINDER | — | area | selectable | class.talent.signature-abilities@1:selectable, class.talent.signature-abilities@2:selectable, class.talent.signature-abilities@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:effect; effect-paragraph:strained |
| hero-standalone | Kinetic Pulse | COMPILES_WITH_REMAINDER | — | area | selectable | class.talent.signature-abilities@1:selectable, class.talent.signature-abilities@2:selectable, class.talent.signature-abilities@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:strained |
| hero-standalone | Materialize | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.signature-abilities@1:selectable, class.talent.signature-abilities@2:selectable, class.talent.signature-abilities@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:effect; effect-paragraph:strained |
| hero-standalone | Mind Spike | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.features@1:selectable, class.talent.features@2:selectable, class.talent.features@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:strained |
| hero-standalone | Optic Blast | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.signature-abilities@1:selectable, class.talent.signature-abilities@2:selectable, class.talent.signature-abilities@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:effect; effect-paragraph:strained; potency:M < SYM prone |
| hero-standalone | Smolder | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.ability-3@1:selectable, class.talent.ability-3@2:selectable, class.talent.ability-3@3:selectable | effect-paragraph:effect; potency:R < SYM the target has weakness N (save ends); potency:R < SYM the target has weakness equal to N + your reason score (save ends) |
| hero-standalone | Spirit Sword | COMPILES_WITH_REMAINDER | — | single | selectable | class.talent.signature-abilities@1:selectable, class.talent.signature-abilities@2:selectable, class.talent.signature-abilities@3:selectable | envelope:structured-markdown-mismatch; effect-paragraph:effect; effect-paragraph:strained |
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | effect-paragraph | effect-paragraph:effect | 1186 | 1172 | `complication:Corrupted Mentor/corrupt-spirit`, `complication:Dragon Dreams/dragon-breath`, `complication:Grounded/motivate-earth` |
| 2 | no-power-roll | no-power-roll | 667 | 667 | `complication:Advanced Studies/advanced-studies-study-notebook`, `complication:Animal Form/animal-form`, `complication:Bereaved/bereaved-ask-the-spirit` |
| 3 | trigger | trigger | 207 | 207 | `foe-feature:9d1bd539-c732-4fba-95d1-ac7036cb89dc`, `mcdm.beastheart.v1/feature.ability.beastheart.level-1/pyre`, `mcdm.beastheart.v1/feature.ability.beastheart.level-1/shadow-in-the-mist` |
...
| --- | ---: | ---: |
| effect-paragraph | 1257 | 12 |
| potency-condition | 1029 | 207 |
| no-power-roll | 667 | 1 |
| tier-damage | 266 | 98 |
| unknown | 243 | 55 |
| trigger | 207 | 1 |
...
| hero-standalone | no-power-roll | 109 |
| hero-standalone | roll-expression-outside-grammar | 4 |
| hero-standalone | tier1-damage-outside-grammar | 21 |
