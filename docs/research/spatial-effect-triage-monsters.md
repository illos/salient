...
- **Other catalog — configurable Animals**, `monster/group/animal.md` § **Defensive Traits / Camouflage (1 Point)**: **Unknown fact:** No enemy has line of effect to the animal. **Timing/input burden:** At animal turn end. **Deterministic portion:** Automatic hide if the predicate holds; permission to attempt hiding while observed is independent. Applies only when this customizable trait was selected; example animals are not additional imported owners.
- **Other catalog — configurable Animals**, `monster/group/animal.md` § **Defensive Traits / Pack (1 Point)**: **Unknown fact:** Animal is adjacent to an ally. **Timing/input burden:** At flanking or frightened application. **Deterministic portion:** Cannot be flanked or made frightened while qualified. Applies only when this customizable trait was selected; example animals are not additional imported owners.
- **Other catalog — configurable Animals**, `monster/group/animal.md` § **Defensive Traits / Spiny (1 Point)**: **Unknown fact:** Grabbing or melee-ability enemy is adjacent. **Timing/input burden:** Each qualifying enemy grab or melee ability. **Deterministic portion:** That enemy takes 3 damage. Applies only when this customizable trait was selected; example animals are not additional imported owners.
- **Other catalog — configurable Animals**, `monster/group/animal.md` § **Defensive Traits / Stench (2 Points)**: **Unknown fact:** Which enemies are adjacent to the animal. **Timing/input burden:** At animal turn start. **Deterministic portion:** Adjacent enemies with Might below 1 must shift 1 away; this is simple recipient membership, retained as boundary context. Applies only when this customizable trait was selected; example animals are not additional imported owners.
- **Other catalog — configurable Animals**, `monster/group/animal.md` § **Offensive Traits / Pouncer (1 Point)**: **Unknown fact:** Animal actually lands on an enemy its size or smaller. **Timing/input burden:** After the maneuver jump. **Deterministic portion:** Qualifying enemy falls prone and animal may make a free strike; jump allowance is independent. Applies only when this customizable trait was selected; example animals are not additional imported owners.
