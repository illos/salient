...
export const SELECTIONS: ManifestSelection[] = [
  ...
  {
    id: 'tactician-levels-two-three',
    description:
      'Tactician levels two and three: doctrine features, perk, Out of Position and all ten ability alternatives.',
    paths: [2, 3].flatMap(level => [
      `feature/tactician/level-${level}`,
      `feature/ability/tactician/level-${level}`,
    ]),
  ...
  {
    id: 'null-levels-two-three',
    description:
      'Null levels two and three: tradition features, perk, Psionic Leap, Reorder and all ten ability alternatives.',
    paths: [2, 3].flatMap(level => [
      `feature/null/level-${level}`,
      `feature/ability/null/level-${level}`,
    ]),
  ...
  {
    id: 'conduit-levels-two-three',
    description:
      'Conduit levels two and three: The Lists of Heaven, perk, second domain feature, all twelve domain abilities, Minor Miracle and four 7-Piety alternatives.',
    paths: [2, 3].flatMap(level => [
      `feature/conduit/level-${level}`,
      `feature/ability/conduit/level-${level}`,
    ]),
    basis: 'docs/build/V134-conduit-level-three.md#scope: Conduit levels two and three.',
  },
  {
    id: 'talent-levels-two-three',
    description:
      'Talent levels two and three: tradition features, perk, Scan and all ten ability alternatives.',
    paths: [2, 3].flatMap(level => [
      `feature/talent/level-${level}`,
      `feature/ability/talent/level-${level}`,
    ]),
