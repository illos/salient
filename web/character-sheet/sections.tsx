...
import { xpProgressRows, type XpProgress } from '../../shared/evaluate/xpAdvancement';
...
export function StatsList({
  ...
  /** V191: server-computed XP bank at the campaign's XP per level, and lifetime XP. */
  xp: XpProgress | null;
  compact?: boolean;
  ...
  if (xp !== null) rows.push(...xpProgressRows(xp));
  return (
    <ul
      className={cn(
