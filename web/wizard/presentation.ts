...
export const DECISION_LABELS: Record<string, string> = {
  ...
  'class.summoner.portfolio.blight.5': 'Blight 5-Essence minion',
  'class.summoner.portfolio.graves.5': 'Graves 5-Essence minion',
  'class.summoner.portfolio.spring.5': 'Spring 5-Essence minion',
  'class.summoner.portfolio.storms.5': 'Storms 5-Essence minion',
  'class.summoner.level-2.stamina': 'Level 2 Stamina',
  'class.summoner.level-2.perk': 'Level 2 perk',
  'class.summoner.level-2.features': "Summoner's Dominion and New Portfolio Minion",
  'class.summoner.level-2.dominion.blight': "Summoner's Dominion fixture",
  'class.summoner.level-2.dominion.graves': "Summoner's Dominion fixture",
  'class.summoner.level-2.dominion.spring': "Summoner's Dominion fixture",
  'class.summoner.level-2.dominion.storms': "Summoner's Dominion fixture",
  'class.summoner.level-3.stamina': 'Level 3 Stamina',
  'class.summoner.level-3.features': "Summoner's Kit",
  'class.summoner.level-3.ward': 'Level 3 ward',
  'class.summoner.level-3.ability-7': 'Level 3 7-Essence ability',
  ...
  'class.talent.level-2.stamina': 'Level 2 Stamina',
  'class.talent.level-2.perk': 'Level 2 perk',
  'class.talent.level-2.ease-the-hours': 'Ease the Hours',
  'class.talent.level-2.ease-their-fall': 'Ease Their Fall',
  'class.talent.level-2.ease-the-mind': 'Ease the Mind',
  'class.talent.level-2.chronopathy-ability': 'Level 2 Chronopathy ability',
  'class.talent.level-2.telekinesis-ability': 'Level 2 Telekinesis ability',
  'class.talent.level-2.telepathy-ability': 'Level 2 Telepathy ability',
  'class.talent.level-3.stamina': 'Level 3 Stamina',
  'class.talent.level-3.scan': 'Scan',
  'class.talent.level-3.ability-7': 'Level 3 7-Clarity ability',
  'class.beastheart.level-2.stamina': 'Level 2 Stamina',
  'class.beastheart.level-2.everyones-best-friend': "Everyone's Best Friend",
  'class.beastheart.level-2.perk': 'Level 2 perk',
  'class.beastheart.level-2.watchdog': 'Watchdog',
  'class.beastheart.level-2.supersniffer': 'Supersniffer',
  'class.beastheart.level-2.this-ones-yours': "This One's Yours",
  'class.beastheart.level-2.stormheart': 'Stormheart',
  'class.beastheart.level-2.guardian-ability': 'Level 2 Guardian ability',
  'class.beastheart.level-2.prowler-ability': 'Level 2 Prowler ability',
  'class.beastheart.level-2.punisher-ability': 'Level 2 Punisher ability',
