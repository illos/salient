...
export const levelOneDecisions: Decision[] = [
  auto(
    'ancestry.wode-elf.base-statistics',
    'ancestry.choice',
    'Wode Elf',
  ...
  auto(
    'ancestry.wode-elf.signature-trait',
    'ancestry.choice',
    'Wode Elf',
    trait('wode-elf-glamor'),
    'You can magically alter your appearance to better blend in with your surroundings.',
    [grant('ancestry-signature-trait', 'Wode Elf Glamor', trait('wode-elf-glamor'))],
  ),
  choice(
    'ancestry.wode-elf.purchased-traits',
    'ancestry.choice',
    'Wode Elf',
    trait('wode-elf-traits'),
    ...
    [
      ...
      option('The Wode Defends', trait('the-wode-defends'), {
        cost: 2,
        grants: [
          grant(
            'ancestry-ability',
            'The Wode Defends',
            path('feature/ability/wode-elf/the-wode-defends'),
          ),
        ],
      }),
    ],
